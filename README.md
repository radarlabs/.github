## 👋 Hey from Radar
[Radar](https://radar.com) is a location platform for developers — think of it like a Location OS to build experiences with using geofencing, trip tracking, and geocoding. You can do this with Radar's SDKs and APIs that help thousands of developers create product experiences like pickup and delivery tracking, location-triggered notifications, location verification, store locations, address autocomplete, and more.
